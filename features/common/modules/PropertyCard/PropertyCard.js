    ...
    return(
        <Box marginBottom="4rem" backgroundColor="#fff" >
            ...
            justifyContent="space-between" >
                ...
                <Box margin="1rem"> <Badge colorScheme="green"> {purpose} </Badge>
                </Box>
                <Box height='50%' bgGradient="linear(to-t, #0a0b1cd9, #ffffff00 100%)"
                display="flex"
                alignItems="flex-end"
                padding="1rem">
                   <Text fontFamily="3xl" fontWeight="medium" color="whiteAlpha.900"> {price}</Text>
            ...
            <Box padding="1.5rem">
                ...
                <HStack spacing="1.3" marginTop="1rem" >
